...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("viewer", "post", "/api/helper/pairing-codes", None, 201),
        ("viewer", "get", "/api/helper/devices", None, 200),
        ...
        ("viewer", "post", "/api/assets/batch/archive", {"asset_ids": ["asset-bracket", "asset-cube"]}, 403),
        ("viewer", "get", "/api/admin/libraries/models/exclude-rules", None, 403),
        ...
        ("editor", "post", "/api/assets/batch/archive", {"asset_ids": ["asset-bracket", "asset-cube"]}, 200),
        ("editor", "post", "/api/admin/libraries/models/exclude-rules", {"pattern": "drafts/**"}, 403),
        ...
        ("admin", "get", "/api/admin/libraries/models/exclude-rules", None, 200),
        ("admin", "get", "/api/helper/devices", None, 200),
    ],
)
